...
a persistence unit "practicojavaeePersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "practicojavaee/pom.xml":
...
artifacts ("practicojavaee-ejb.jar" and "practicojavaee-web.war") are already built. You can build
